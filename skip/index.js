...
import { solid, schema, space, rdf, foaf, acl} from 'rdf-namespaces';
...
btns.forEach(function(btn) {
  btn.addEventListener("click", function(e){
    ...
    // Participate in a data request
      ...
      const participate_period = new Date(document.getElementById("participate_period").value);
      console.log(participate_period);
